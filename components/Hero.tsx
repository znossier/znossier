              ...
              {mockContact.socialLinks.map((social) => (
                ...
                >
                  ...
                  {social.platform === 'Behance' && (
                    <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          ...
          >
            <motion.div
              ...
              className={`absolute inset-0 w-full h-full rounded-2xl overflow-hidden transition-shadow duration-300 ${
            ...
            >
              ...
              <div className="w-full h-full bg-accent/10 rounded-2xl flex items-center justify-center text-5xl image-fallback" style={{ display: mockAbout.image ? 'none' : 'flex' }} aria-hidden="true">
                👩🏻‍💻
              </div>
            </motion.div>
          </motion.div>
