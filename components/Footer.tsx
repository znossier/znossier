            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 text-sm text-foreground/70 hover:text-foreground transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-link focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded w-fit"
                ...
                <p className="inline-flex items-center gap-2.5 text-sm text-foreground/70 leading-relaxed">
                  <svg
                    className="w-4 h-4 flex-shrink-0 self-center"
                    fill="none"
                    stroke="currentColor"
