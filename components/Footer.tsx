                    ...
                    return (
                      <li key={item.href}>
                        <a
                          ...
                          className="text-sm text-foreground/70 hover:text-foreground underline-animate transition-colors duration-200 focus:outline-none focus-visible:text-link focus-visible:ring-2 focus-visible:ring-link focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded"
                        >
                          {item.label}
                        </a>
                      </li>
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-sm text-foreground/70 hover:text-foreground transition-colors duration-200 focus:outline-none focus-visible:text-link focus-visible:ring-2 focus-visible:ring-link focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded w-fit"
